...
namespace LerosClient
{
    ...
    public class text : Element
    {
        ...
        private Bitmap GenerateBitmap()
        {
            ...
            HtmlRenderer.Render(g, "<style type=\"text/css\">body{color: " + ColorTranslator.ToHtml(this.ForeColor) + ";}</style> <font face=\"MS Sans Serif\"> <span  color=\"" + ColorTranslator.ToHtml(ForeColor) + "\">" + Text + "</span></font>", new Point(0, 0), this.Width);
            return c;
        }
        /// <summary>
        /// Draw
